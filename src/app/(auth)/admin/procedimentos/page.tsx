...
export const metadata = { title: 'Procedimentos — Painel BI' }
...
export default async function ProcedimentosPage() {
  ...
  return <MasterCrudClient tableName="procedimentos" label="Procedimento" labelPlural="Procedimentos" initialData={data || []} />
}
