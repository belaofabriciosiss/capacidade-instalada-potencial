...
export const metadata = { title: 'Profissionais — Painel BI' }
...
export default async function ProfissionaisPage() {
  ...
  return <MasterCrudClient tableName="profissionais" label="Profissional" labelPlural="Profissionais" initialData={data || []} />
}
